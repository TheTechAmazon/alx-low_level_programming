...
/**
 * print_osabi _ prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 * @e-ident; A pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e-ident)
{
 ...
 * @e-entry: the address of the ELF entry point.
 * @e_ident: A pointer to an array containing thr ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
